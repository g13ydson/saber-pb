function isPaginaMinhasAulas() {
  // http://1gre.saber.pb.gov.br/platform/teachings
...
function isPaginaAulas() {
  // http://1gre.saber.pb.gov.br/platform/teachings/1078922/class_logs
  return window.location.pathname.endsWith("/class_logs");
}

function isPaginaFrequencias() {
  // http://1gre.saber.pb.gov.br/platform/teachings/1078922/class_frequencies
...
function isPaginaNovaAula() {
  // http://1gre.saber.pb.gov.br/platform/teachings/1078922/class_logs/new
  return window.location.pathname.endsWith("/class_logs/new");
}


function isPaginaDesempenhoEscolaEdit() {
  // http://1gre.saber.pb.gov.br/platform/school_classes/196362/enrollments/4663358/enrollment_early_years_rating_reports/1025520/edit
    ...
    if (primeira_linha.startsWith('#')) {
      ...
      if (codigo == '' || isNaN(codigo)) {
        ...
        if (!window.location.pathname.includes(codigo)) {
          console.log(`Redireciona para http://1gre.saber.pb.gov.br/platform/teachings/${codigo}`);
          window.location.href = `http://1gre.saber.pb.gov.br/platform/teachings/${codigo}`;
        } else {
...
// </a>
// http://1gre.saber.pb.gov.br/platform/teachings/320557/class_logs
...
function criarComentariosDeTurmas() {
  ...
  for (r of registros) {
    ...
    let link = r.children[9].querySelector('a').href
      // http://1gre.saber.pb.gov.br/platform/teachings/1238787/class_logs
...
function isPaginaDeAtualizacaoDeAtividadeComplementar() {
  // http://1gre.saber.pb.gov.br/platform/complementary_activity_teachings/24839/complementary_activity_class_logs/new
